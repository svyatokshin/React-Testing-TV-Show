...
test('Episodes list shows data when rerendered with new episodes data', () => {
      const { queryAllByTestId, rerender} = render(<Episodes error='' episodes={[]} />);

      // assert that there are no episodes listed when the component first renders
