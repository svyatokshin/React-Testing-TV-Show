...
console.log('this is the mockFetchShow', mockFetchShow);
...
// use async/await
test('App fetches episode data and renders dropdown', async () => {
    mockFetchShow.mockResolvedValueOnce(episodesList);
